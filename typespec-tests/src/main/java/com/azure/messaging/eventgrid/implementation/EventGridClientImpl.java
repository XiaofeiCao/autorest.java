...
public final class EventGridClientImpl {
    ...
    public interface EventGridClientService {
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<Void> publishCloudEventSync(
                @HostParam("endpoint") String endpoint,
                @QueryParam("api-version") String apiVersion,
                @HeaderParam("content-type") String contentType,
                @PathParam("topicName") String topicName,
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<Void> publishBatchOfCloudEventsSync(
                @HostParam("endpoint") String endpoint,
                @QueryParam("api-version") String apiVersion,
                @HeaderParam("content-type") String contentType,
                @PathParam("topicName") String topicName,
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> receiveBatchOfCloudEventsSync(
                @HostParam("endpoint") String endpoint,
                @QueryParam("api-version") String apiVersion,
                @PathParam("topicName") String topicName,
                @PathParam("eventSubscriptionName") String eventSubscriptionName,
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> acknowledgeBatchOfCloudEventsSync(
                @HostParam("endpoint") String endpoint,
                @QueryParam("api-version") String apiVersion,
                @HeaderParam("content-type") String contentType,
                @PathParam("topicName") String topicName,
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> releaseBatchOfCloudEventsSync(
                @HostParam("endpoint") String endpoint,
                @QueryParam("api-version") String apiVersion,
                @HeaderParam("content-type") String contentType,
                @PathParam("topicName") String topicName,
    ...
    public Response<Void> publishBatchOfCloudEventsWithResponse(
        ...
        final String contentType = "application/cloudevents-batch+json; charset=utf-8";
        final String accept = "application/json";
        return service.publishBatchOfCloudEventsSync(
                this.getEndpoint(),
                this.getServiceVersion().getVersion(),
                contentType,
                topicName,
    ...
    public Response<BinaryData> receiveBatchOfCloudEventsWithResponse(
            String topicName, String eventSubscriptionName, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.receiveBatchOfCloudEventsSync(
                this.getEndpoint(),
                this.getServiceVersion().getVersion(),
                topicName,
                eventSubscriptionName,
    ...
    public Response<BinaryData> acknowledgeBatchOfCloudEventsWithResponse(
        ...
        final String contentType = "application/json; charset=utf-8";
        final String accept = "application/json";
        return service.acknowledgeBatchOfCloudEventsSync(
                this.getEndpoint(),
                this.getServiceVersion().getVersion(),
                contentType,
                topicName,
    ...
    public Response<BinaryData> releaseBatchOfCloudEventsWithResponse(
        ...
        final String contentType = "application/json; charset=utf-8";
        final String accept = "application/json";
        return service.releaseBatchOfCloudEventsSync(
                this.getEndpoint(),
                this.getServiceVersion().getVersion(),
                contentType,
                topicName,
