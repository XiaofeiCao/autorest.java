...
package com.azure.resourcemanager.resource.implementation;
...
import com.azure.resourcemanager.resource.fluent.TopLevelsClient;
import com.azure.resourcemanager.resource.fluent.models.TopLevelTrackedResourceInner;
import com.azure.resourcemanager.resource.implementation.models.TopLevelTrackedResourceListResult;
...
public final class TopLevelsClientImpl implements TopLevelsClient {
     ...
     */
    private final ResourceClientImpl client;
     ...
     */
    TopLevelsClientImpl(ResourceClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ResourceClientTopLevels to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ResourceClientTopLev")
    public interface TopLevelsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resource/topLevelTrackedResources/{topLevelTrackedResourceName}")
        ...
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resource/topLevelTrackedResources/{topLevelTrackedResourceName}")
        ...
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resource/topLevelTrackedResources/{topLevelTrackedResourceName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resource/topLevelTrackedResources/{topLevelTrackedResourceName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resource/topLevelTrackedResources")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/providers/Azure.ResourceManager.Resource/topLevelTrackedResources")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resource/topLevelTrackedResources/{topLevelTrackedResourceName}/actionSync")
