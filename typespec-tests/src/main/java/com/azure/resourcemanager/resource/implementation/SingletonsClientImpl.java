...
import com.azure.resourcemanager.resource.fluent.SingletonsClient;
import com.azure.resourcemanager.resource.fluent.models.SingletonTrackedResourceInner;
import com.azure.resourcemanager.resource.implementation.models.SingletonTrackedResourceListResult;
...
public final class SingletonsClientImpl implements SingletonsClient {
     ...
     */
    SingletonsClientImpl(ResourceClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ResourceClientSingletons to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ResourceClientSingle")
    public interface SingletonsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resource/singletonTrackedResources/default")
        ...
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resource/singletonTrackedResources/default")
        ...
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resource/singletonTrackedResources/default")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resource/singletonTrackedResources")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
