...
import com.azure.resourcemanager.commontype.managedidentity.models.Properties;
...
public final class PropertiesImpl implements Properties {
    ...
    private final com.azure.resourcemanager.commontype.managedidentity.ManagedIdentityManager serviceManager;

    public PropertiesImpl(PropertiesClient innerClient,
        com.azure.resourcemanager.commontype.managedidentity.ManagedIdentityManager serviceManager) {
    ...
    private com.azure.resourcemanager.commontype.managedidentity.ManagedIdentityManager manager() {
