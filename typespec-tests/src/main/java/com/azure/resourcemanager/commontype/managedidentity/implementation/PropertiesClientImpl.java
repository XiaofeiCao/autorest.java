...
package com.azure.resourcemanager.commontype.managedidentity.implementation;
...
import com.azure.resourcemanager.commontype.managedidentity.fluent.PropertiesClient;
import com.azure.resourcemanager.commontype.managedidentity.fluent.models.ManagedIdentityTrackedResourceInner;
...
public final class PropertiesClientImpl implements PropertiesClient {
     ...
     */
    PropertiesClientImpl(ManagedIdentityClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ManagedIdentityClientProperties to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    ...
    public interface PropertiesService {
        ...
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.CommonType.ManagedIdentity/managedIdentityTrackedResources/{managedIdentityTrackedResourceName}")
        ...
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.CommonType.ManagedIdentity/managedIdentityTrackedResources/{managedIdentityTrackedResourceName}")
        ...
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.CommonType.ManagedIdentity/managedIdentityTrackedResources/{managedIdentityTrackedResourceName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
