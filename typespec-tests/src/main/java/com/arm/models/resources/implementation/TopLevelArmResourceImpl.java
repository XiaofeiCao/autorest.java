...
import com.arm.models.resources.models.TopLevelArmResourceUpdateProperties;
...
public final class TopLevelArmResourceImpl
    ...
    public TopLevelArmResource create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .createOrReplace(resourceGroupName, topLevelArmResourceName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public TopLevelArmResource create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getTopLevelArmResources()
            .createOrReplace(resourceGroupName, topLevelArmResourceName, this.innerModel(), context);
        return this;
    }

    TopLevelArmResourceImpl(String name, com.arm.models.resources.ResourcesManager serviceManager) {
    ...
    public TopLevelArmResource apply() {
        this.innerObject = serviceManager.serviceClient()
            .getTopLevelArmResources()
            .update(resourceGroupName, topLevelArmResourceName, updateProperties, Context.NONE);
        return this;
    }
    ...
    public TopLevelArmResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getTopLevelArmResources()
            .update(resourceGroupName, topLevelArmResourceName, updateProperties, context);
        return this;
    }
