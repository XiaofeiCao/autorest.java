...
import com.arm.models.resources.fluent.TopLevelArmResourcesClient;
import com.arm.models.resources.fluent.models.TopLevelArmResourceInner;
import com.arm.models.resources.implementation.models.TopLevelArmResourceListResult;
import com.arm.models.resources.models.TopLevelArmResourceUpdate;
...
public final class TopLevelArmResourcesClientImpl implements TopLevelArmResourcesClient {
     ...
     */
    TopLevelArmResourcesClientImpl(ResourcesClientImpl client) {
    ...
    /**
     * The interface defining all the services for ResourcesClientTopLevelArmResources to be used by the proxy service
    ...
    public interface TopLevelArmResourcesService {
        ...
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Arm.Models.Resources/topLevelArmResources/{topLevelArmResourceName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Arm.Models.Resources/topLevelArmResources/{topLevelArmResourceName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Arm.Models.Resources/topLevelArmResources/{topLevelArmResourceName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Arm.Models.Resources/topLevelArmResources/{topLevelArmResourceName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Arm.Models.Resources/topLevelArmResources")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/providers/Arm.Models.Resources/topLevelArmResources")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private PollerFlux<PollResult<TopLevelArmResourceInner>, TopLevelArmResourceInner> beginCreateOrReplaceAsync(
        String resourceGroupName, String topLevelArmResourceName, TopLevelArmResourceInner resource) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrReplaceWithResponseAsync(resourceGroupName, topLevelArmResourceName, resource);
    ...
    private PollerFlux<PollResult<TopLevelArmResourceInner>, TopLevelArmResourceInner> beginCreateOrReplaceAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrReplaceWithResponseAsync(resourceGroupName, topLevelArmResourceName, resource, context);
        return this.client.<TopLevelArmResourceInner, TopLevelArmResourceInner>getLroResult(mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<TopLevelArmResourceInner>, TopLevelArmResourceInner> beginCreateOrReplace(
        String resourceGroupName, String topLevelArmResourceName, TopLevelArmResourceInner resource) {
        return this.beginCreateOrReplaceAsync(resourceGroupName, topLevelArmResourceName, resource).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<TopLevelArmResourceInner>, TopLevelArmResourceInner> beginCreateOrReplace(
        String resourceGroupName, String topLevelArmResourceName, TopLevelArmResourceInner resource, Context context) {
        return this.beginCreateOrReplaceAsync(resourceGroupName, topLevelArmResourceName, resource, context)
            .getSyncPoller();
    }
    ...
    private Mono<TopLevelArmResourceInner> createOrReplaceAsync(String resourceGroupName,
        String topLevelArmResourceName, TopLevelArmResourceInner resource) {
        return beginCreateOrReplaceAsync(resourceGroupName, topLevelArmResourceName, resource).last()
    ...
    private Mono<TopLevelArmResourceInner> createOrReplaceAsync(String resourceGroupName,
        String topLevelArmResourceName, TopLevelArmResourceInner resource, Context context) {
        return beginCreateOrReplaceAsync(resourceGroupName, topLevelArmResourceName, resource, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public TopLevelArmResourceInner createOrReplace(String resourceGroupName, String topLevelArmResourceName,
        ...
        return createOrReplaceAsync(resourceGroupName, topLevelArmResourceName, resource).block();
    }
    ...
    public TopLevelArmResourceInner createOrReplace(String resourceGroupName, String topLevelArmResourceName,
        ...
        return createOrReplaceAsync(resourceGroupName, topLevelArmResourceName, resource, context).block();
    }
    ...
    private PollerFlux<PollResult<TopLevelArmResourceInner>, TopLevelArmResourceInner> beginUpdateAsync(
        String resourceGroupName, String topLevelArmResourceName, TopLevelArmResourceUpdate properties) {
        Mono<Response<Flux<ByteBuffer>>> mono
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<TopLevelArmResourceInner>, TopLevelArmResourceInner>
        beginUpdate(String resourceGroupName, String topLevelArmResourceName, TopLevelArmResourceUpdate properties) {
