...
/**
 * Initializes a new instance of the InheritanceClientImpl type.
 */
@ServiceClient(builder = InheritanceClientBuilder.class)
public final class InheritanceClientImpl implements InheritanceClient {
    /**
     * Server parameter.
     */
     ...
     */
    InheritanceClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(InheritanceClientImpl.class);
}
