...
import com.azure.resourcemanager.resource.ResourceManager;
import com.azure.resourcemanager.resource.models.NestedProxyResource;
import com.azure.resourcemanager.resource.models.NestedProxyResourceProperties;
import com.azure.resourcemanager.resource.models.NotificationDetails;
import com.azure.resourcemanager.resource.models.ProvisioningState;
import com.azure.resourcemanager.resource.models.TopLevelTrackedResource;
import com.azure.resourcemanager.resource.models.TopLevelTrackedResourceProperties;
...
public class ArmResourceTest {
    private static final String TOP_LEVEL_TRACKED_RESOURCE_ID = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Azure.ResourceManager.Resource/topLevelTrackedResources/top";
    private static final String TOP_LEVEL_TRACKED_RESOURCE_NAME = "top";
    private static final String TOP_LEVEL_TRACKED_RESOURCE_TYPE = "Azure.ResourceManager.Resource/topLevelTrackedResources";
    private static final String NESTED_PROXY_RESOURCE_ID = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Azure.ResourceManager.Resource/topLevelTrackedResources/top/nestedProxyResources/nested";
    private static final String NESTED_PROXY_RESOURCE_NAME = "nested";
    private static final String NESTED_PROXY_RESOURCE_TYPE = "Azure.ResourceManager.Resource/topLevelTrackedResources/top/nestedProxyResources";
    ...
    private final ResourceManager manager = ResourceManager.authenticate(
    ...
    public void testTopLevelTrackedResource() {
        ...
        manager.topLevels().actionSync(RESOURCE_GROUP_NAME, TOP_LEVEL_TRACKED_RESOURCE_NAME,
